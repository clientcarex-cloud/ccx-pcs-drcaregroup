...
$is_staff_with_view_perm = staff_can('view', 'customers') && !is_client_logged_in();
$can_view_referral_table = AffiliateManagementHelper::get_option('affiliate_management_disable_referral_table_for_affiliates', $affiliate) != '1';
if ($is_staff_with_view_perm)
    $can_view_referral_table = true;
?>
<div class="content affiliate-view">
    ...
    <div class="panel panel-default tw-mt-8">
        <div class="panel-body">
            ...
            <!-- profile info -->
            <?php if ($is_staff_with_view_perm) : ?>
    ...
    <?php if ($can_view_referral_table) : ?>
    <div class="row tw-mt-4">
