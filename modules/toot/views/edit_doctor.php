...
<div class="form-section">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="mb-3" style="display: flex; gap: 0;">
                ...
                <div style="flex: 1; max-width: 49%;">
                    <input type="text" class="form-control" name="firstname" placeholder="<?php echo _l('enter_doctor_name'); ?>" value="<?= $doctor->firstname ?>" required>
                </div>
                <div style="flex: 1; max-width: 29%;">
                    <select class="form-control" name="gender">
                        <option value="Male" <?= $doctor_new_fields->gender == "Male" ? 'selected' : ''; ?>><?php echo _l('male'); ?></option>
                        <option value="Female" <?= $doctor_new_fields->gender == "Female" ? 'selected' : ''; ?>><?php echo _l('female'); ?></option>
                        <option value="Other" <?= $doctor_new_fields->gender == "Other" ? 'selected' : ''; ?>><?php echo _l('other'); ?></option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="phonenumber" placeholder="<?php echo _l('enter_number'); ?>" value="<?= $doctor->phonenumber ?>" required>
        </div>

        <!-- Email -->
        <div class="col-md-4">
            <label><?php echo _l('email'); ?></label>
            <input type="email" class="form-control" name="email" placeholder="<?php echo _l('enter_email_address'); ?>" value="<?= $doctor->email ?>">
        </div>
    </div>
    <br>
    <div class="row mt-3">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="qualification" placeholder="<?php echo _l('enter_qualification'); ?>" value="<?= $doctor_new_fields->qualification ?>">
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="location" placeholder="<?php echo _l('enter_location'); ?>" value="<?= $doctor_new_fields->location ?>" required>
        </div>
    </div>
    ...
    <div id="consultation-slots">
        <?php 
        $slotIndex = 0;
        foreach ($doctor_time_slots as $slot) : ?>
        <div class="row slot-row mb-2">
            ...
            ?>
                <select class="form-control" name="slots[<?= $slotIndex ?>][day_of_week]" required>
                    <option value="Mon" <?= $slot['day_of_week'] == 'Mon' ? 'selected' : ''; ?>>Mon</option>
                    <option value="Tue" <?= $slot['day_of_week'] == 'Tue' ? 'selected' : ''; ?>>Tue</option>
                    <option value="Wed" <?= $slot['day_of_week'] == 'Wed' ? 'selected' : ''; ?>>Wed</option>
                    <option value="Thu" <?= $slot['day_of_week'] == 'Thu' ? 'selected' : ''; ?>>Thu</option>
                    <option value="Fri" <?= $slot['day_of_week'] == 'Fri' ? 'selected' : ''; ?>>Fri</option>
                    <option value="Sat" <?= $slot['day_of_week'] == 'Sat' ? 'selected' : ''; ?>>Sat</option>
                </select>
            </div>
            <div class="col-md-3">
            <?php
            ...
            ?>
                <input type="time" class="form-control" name="slots[<?= $slotIndex ?>][shift_start_time]" value="<?= $slot['shift_start_time'] ?>" required>
            </div>
            <div class="col-md-3">
            <?php
            if($slotIndex == 0){
            ...
            ?>
             <input type="time" class="form-control" name="slots[<?= $slotIndex ?>][shift_end_time]" value="<?= $slot['shift_end_time'] ?>" required>
            </div>
            <div class="col-md-3">
                <?php
                if($slotIndex == 0){
                    ?>
                     <label><?php echo _l('avg_session_time'); ?> (<?php echo _l('minutes'); ?>) *</label>
                    <?php
                }
                ?>
                
                <input type="number" class="form-control" name="slots[<?= $slotIndex ?>][avg_session_time]" value="<?= $slot['avg_session_time'] ?>" required>
            </div>
        ...
        <br>
        <?php $slotIndex++; endforeach; ?>
        <div class="row">
        <div class="col-md-11 d-flex "></div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="licence_number" placeholder="<?php echo _l('enter_license_number'); ?>" value="<?= $doctor_new_fields->licence_number ?>">
        </div>
